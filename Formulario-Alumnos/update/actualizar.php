...
<body>
    <form action="Proceso_update.php" method="POST" enctype="multipart/form-data"><!--formulario que lleva al proceso de update cuando se oprime el boton -->
        <?php
        ...
        <tr>
            ...
            <p>Email:<input type="text" name="Email" value="<?php echo $mostrar['Email'] ?>" /></p><!--El if  Deja escrito en el contenido cuando se recarga la pagina y al entrar a la pagina al ser una variable global -->
